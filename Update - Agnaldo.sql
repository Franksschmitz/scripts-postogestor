...
BEGIN
    ...
    l_id_filial = 4; -- Informar a ID_EMPRESA que deseja reprocessar
    l_id_cfgfiscal = '14-1'; -- Informar a ID_CFGFISCAL base
    l_id_imposto = '5-1'; -- Informar a ID_IMPOSTO que deseja reprocessar
	l_al_imposto = '3';
    l_data_ini = '2020-09-01'; -- 'yyyy-mm-dd'
    l_data_fim = '2020-09-30'; -- 'yyyy-mm-dd'
    
	
    FOR l_id_cst, l_id_natoper IN 
